...
if __name__ == '__main__':
    ...
    model = LSTM_CNN(input_size_ra, input_size_meta, hidden_size, output_size, num_layers, device, use_ra = True).to(device)
    print(model)
    ...
    print("Finel CNN+LSTM MSE denormed over all timestep: {} \nFinel CNN+LSTM MSE denormed for each timestep: {}".format(model_loss, model_loss_ts))
